<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin_layout.Master" AutoEventWireup="true" CodeBehind="Admin_DB_manageAdmins.aspx.cs" Inherits="SLTB.admin.WebForm1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="main_content" runat="server">
     <div class="dashboard-header">
        <h1 class="h2">Manage Admins</h1>
        <p>Add, edit, delete Admins.</p>
    </div>
